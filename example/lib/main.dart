...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    super.initState();
    final animationDuration = 3;
    _controllerCenter = ConfettiController(duration: Duration(seconds: animationDuration));
    _controllerCenterRight = ConfettiController(duration: Duration(seconds: animationDuration));
    _controllerCenterLeft = ConfettiController(duration: Duration(seconds: animationDuration));
    _controllerTopCenter = ConfettiController(duration: Duration(seconds: animationDuration));
    _controllerBottomCenter = ConfettiController(duration: Duration(seconds: animationDuration));
  }
